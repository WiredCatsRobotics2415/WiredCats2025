...
public class LocalADStarAK implements Pathfinder {
     ...
     *
     * @param startPosition Start position on the field. If this is within an obstacle it
     *                      will be moved to the nearest non-obstacle node.
     */
    @Override
     ...
     *
     * @param goalPosition Goal position on the field. f this is within an obstacle it will
     ...
     * @param currentRobotPos The current position of the robot. This is needed to change
     *                        the start position of the path to properly avoid obstacles
     */
    @Override
