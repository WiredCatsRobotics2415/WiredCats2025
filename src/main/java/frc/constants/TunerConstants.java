...
public class TunerConstants {
    ...
    private static final Slot0Configs driveGains = new Slot0Configs().withKP(4.58).withKI(0)
        .withKD(0).withKS(0.3).withKV(0.1).withKA(0);
    ...
    public static final SwerveDrive DriveTrain = new SwerveDrive(DrivetrainConstants,
