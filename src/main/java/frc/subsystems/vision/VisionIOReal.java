...
public class VisionIOReal implements VisionIO {
    ...
    public void updateInputs(VisionIOInputsAutoLogged inputs) {
        ...
        for (int i = 0; i < poseEstimationLimelightNames.length; i++) {
            ...
            inputs.poseEstimates[i] = poseEstimate.pose;
            inputs.poseTimestampsSeconds[i] = poseEstimate.timestampSeconds;
            inputs.poseLatencies[i] = poseEstimate.latency;
            inputs.poseTagCounts[i] = poseEstimate.tagCount;
        }
    }
