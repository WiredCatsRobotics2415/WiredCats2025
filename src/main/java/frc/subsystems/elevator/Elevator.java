...
public class Elevator extends SubsystemBase {
    ...
    private double getPotRotations() {
        ...
        double measure = ElevatorConstants.MaxHeight - (((input.getAverageVoltage() - ElevatorConstants.MIN_VOLT) /
            (ElevatorConstants.MAX_VOLT - ElevatorConstants.MIN_VOLT)) * ElevatorConstants.MaxHeight);
        return measure;
    }
